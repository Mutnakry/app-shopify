...
export default function By_Category_Product({ isAuthenticated }) {
    ...
    const getAllProduct = () => {
        axios
            .get(`http://localhost:6700/api/product/categoryid/${id}`)
            .then(res => {
        ...
        <div className='mt-14'>
            ...
            <div className='max-w-screen-xl mx-auto my-4 px-2'>
                ...
                <nav className="text-sm text-gray-500 mb-4 pt-4 underline underline-offset-8">
                    ...
                    <a href="/discount" className="text-gray-600 font-semibold text-sm"> បញ្ចុះតម្លៃរហូតដល់៥០% </a>
                </nav>
                <div className="flex gap-8">
                    <div className="w-2/6 lg:w-2/6 flex flex-col bg-slate-100 rounded-lg p-4 h-screen ">
                        ...
                        <div className='flex justify-between whitespace-nowrap '>
                            ...
                            <a href="" className='text-xs underline text-gray-700 font-light'>មើលទាំងអស់</a>
